...
{: .note }
> In most cases (except basic one with arguments) you should wrap your method to function conversion with additional parenthesis
> to be able to use scalamock syntax
> For example:  (varargs.example((_: Seq[Int])*)).returnsWith("abc")
...
### Method returning context function

```scala
class ContextFunction:
  def contextFunction(a: String): Int ?=> String

val cf = ContextFunction()

val x = (cf.contextFunction: String => Int ?=> String)
